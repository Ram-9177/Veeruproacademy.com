    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "data-[state=closed]:slide-out-to-right data-[state=open]:custom-slide-in-from-right right-0 border-l border-border",
          side === "left" &&
            "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left left-0 border-r border-border",
          side === "top" &&
            "data-[state=closed]:slide-out-to-top top-0 border-b border-border",
          side === "bottom" &&
            "data-[state=closed]:slide-out-to-bottom bottom-0 border-t border-border",
          className,
        )}
        {...props}
      >
